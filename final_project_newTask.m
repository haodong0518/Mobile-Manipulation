...
Tsc_init =[[0,-1,0,0];[1,0,0,2];[0,0,1,0.025];[0,0,0,1]];
Tsc_goal = [[1,0,0,2];[0,1,0,0];[0,0,1,0.025];[0,0,0,1]];
...
Tse= Tse_init;
current_state = [0;0;0;   0;0;0.2;-1.6;0;     0;0;0;0]; 
...
csvwrite('final_project_test_newtask.csv',configurations);
csvwrite('final_project_Xerr_config_newtask.csv',Xerr_conf);
disp('Done');
diary off;
